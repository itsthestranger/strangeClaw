...
# buffering and must stay strictly above this value. When an operator raises
# this cap without setting `max_frame_bytes`, config loading derives the frame
# cap from it rather than rejecting the config.
